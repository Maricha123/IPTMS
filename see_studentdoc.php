...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT id, file_name, file_content, time_submitted FROM file_uploads WHERE id = '$fileId'";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p><strong>file_content:</strong> <?php echo htmlspecialchars($report['file_content']); ?></p>
                                    <p><strong>time_submitted:</strong> <?php echo htmlspecialchars($report['time_submitted']); ?></p>
                                    <a href="view_file.php?id=<?php echo $report['id']; ?>" class="btn btn-primary">Download</a>
                                    <!-- <a href="displays.php?student_id=?" class="btn btn-secondary">Back to Reports</a> -->
                                </div>
                            </div>
                        </div>
                    </div>
