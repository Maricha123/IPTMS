...
if (isset($_GET['report_id'])) {
    ...
    $sql = "SELECT report_id, works, uploaded_at FROM reports WHERE report_id = '$reportId'";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" style="color:orange">View Your Report</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p><strong>Works:</strong> <?php echo htmlspecialchars($report['works']); ?></p>
                                    <p><strong>Uploaded At:</strong> <?php echo htmlspecialchars($report['uploaded_at']); ?></p>
                                    <a href="download_report.php?report_id=<?php echo $report['report_id']; ?>" class="btn btn-primary">Download</a>
                                    <a href="view_report.php" class="btn btn-secondary">Back to Reports</a>
                                </div>
                            </div>
                        </div>
                    </div>
